...
<div class="wrapper">
                    ...
                    <div class="map-block map-block_fits">
                        <div class="map" style="margin-top: 105px">
                            ...
                            <div class="map__item" data-aos="fade-up" data-aos-duration="1200" data-aos-once="true">
                                ...
                                <p class="map-desc"> We will be creating physical collectible items for our Zombiez  and gifting them to its NFT holder.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="faq-section" id="faq">
            <div class="container">
                ...
                <div class="accordion">
                    ...
                    <div class="accordion__item">
                        <div class="accordion__title-wrap">
                            <h3 class="accordion__title">What is The Zombiez NFT?</h3>
                            <div class="accordion__icon"></div>
                        </div>
                        <div class="accordion__content">
                            <p class="accordion__desc">The Zombiez NFT is an NFT created by a team of NFT enthusiasts who would like to build a community full of fun and games! </p>
                        </div>
                    </div>
                    <div class="accordion__item">
                        <div class="accordion__title-wrap">
                            <h3 class="accordion__title">What can I do with my Zombiez ?</h3>
                            <div class="accordion__icon"></div>
                        </div>
                        <div class="accordion__content">
                            <p class="accordion__desc">Each Zombiez as your pet, also acts as a membership card to enjoy members-only benefits and events exclusively and access our The Zombiez NFT game.
                                Be sure to change your social media’s profile picture and tell your friends and family about it!</p>
                        </div>
                    </div>
                    <div class="accordion__item">
                        <div class="accordion__title-wrap">
                            <h3 class="accordion__title">How can I get a Zombiez ?</h3>
                            <div class="accordion__icon"></div>
                        </div>
                        <div class="accordion__content">
                            <p class="accordion__desc">In order to get a Zombiez , all you need is a MetaMask wallet with some Ethereum in it, then you are good to go!</p>
                        </div>
                    </div>
                    <div class="accordion__item">
                        <div class="accordion__title-wrap">
                            <h3 class="accordion__title">Where can I get my Zombiez ?</h3>
                            <div class="accordion__icon"></div>
                        </div>
                        <div class="accordion__content">
                            <p class="accordion__desc">You can get a Zombiez  through our website when our presale and public sale launches. After that, it will be available for purchase on Opensea for second hand purchases.</p>
                        </div>
                    </div>
                    <div class="accordion__item">
                        <div class="accordion__title-wrap">
                            <h3 class="accordion__title">When can I get my Zombiez ?</h3>
                            <div class="accordion__icon"></div>
                        </div>
                        <div class="accordion__content">
    ...
    <footer class="footer">
        <div class="container">
            ...
            <p class="copyright">COPYRIGHT © The Zombiez NFT. <br> ALL RIGHTS RESERVED</p>
        </div>
    </footer>
